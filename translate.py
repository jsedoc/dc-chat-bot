...
def train():
  ...
  en_train, fr_train, en_dev, fr_dev, _, _ = data_utils.prepare_wmt_data(
      FLAGS.data_dir, FLAGS.cont_vocab_size, FLAGS.resp_vocab_size)
...
def decode():
  with tf.Session() as sess:
    ...
    cont_vocab_path = os.path.join(FLAGS.data_dir,
                                 "vocab%d.cont" % FLAGS.cont_vocab_size)
    resp_vocab_path = os.path.join(FLAGS.data_dir,
                                 "vocab%d.resp" % FLAGS.resp_vocab_size)
    cont_vocab, _ = data_utils.initialize_vocabulary(cont_vocab_path)
    _, rev_fr_vocab = data_utils.initialize_vocabulary(resp_vocab_path)
