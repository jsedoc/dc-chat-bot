...
def load_models(sess):	
        	...
        	_, ood_resp_vocab = data_utils.initialize_vocabulary(ood_resp_vocab_path)
                ...
                return (movies_model,gaming_model,ood_model,movie_cont_vocab,movie_resp_vocab,gaming_cont_vocab,gaming_resp_vocab,ood_cont_vocab,ood_resp_vocab)

movies_model,gaming_model,ood_model,movie_cont_vocab,movie_resp_vocab,gaming_cont_vocab,gaming_resp_vocab,ood_cont_vocab,ood_resp_vocab = load_models(sess)
...
@ask.launch
def ask_intent():
        response = 'Welcome to the domain chat bot'
...
def ask_intent(text,movies_model,gaming_model,ood_model,movie_cont_vocab,movie_resp_vocab,gaming_cont_vocab,gaming_resp_vocab,ood_cont_vocab,ood_resp_vocab):
